...
# First CSV File
#file_id1 = "1Gh2fy_yrGpIr8yRHGAHfgMh2en4cH2Mf"  # Replace with your actual FILE ID
...
# Second CSV File
#file_id2 = "1gZ-MHVCC0w-JqY1DsXyQ2kf9xybzsyDE"  # Replace with your actual FILE ID
...
## Load the second CSV into a Pandas DataFrame
#region_df = pd.read_csv(output2)
...
st.sidebar.image('https://img.olympics.com/images/image/private/t_s_16_9_g_auto/t_s_w2440/f_auto/primary/eet6mquy9fxzn9folznc')
...
if user_menu == 'Athlete wise Analysis':
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
                     ...
                     'Wrestling','Water Polo', 'Hockey', 'Rowing', 'Fencing', 'Shooting', 'Boxing', 'Taekwondo', 'Cycling',
